...
struct Theme {
    ...
    struct HomePage {
        ...
        static let cityWeatherBGColor = UIColor(red: 253/255, green: 217/255, blue: 105/255, alpha: 1.0)
    ...
    struct ForecastPage {
        static let viewBGColor = UIColor(red: 51/255, green: 204/255, blue: 255/255, alpha: 1.0)
        static let listBGColor = UIColor(red: 177/255, green: 203/255, blue: 228/255, alpha: 1.0)
        static let cityWeatherForecastBGColor = UIColor(red: 253/255, green: 217/255, blue: 105/255, alpha: 1.0)
        static let buttonTintColor = UIColor(red: 02/255, green: 02/255, blue: 02/255, alpha: 1.0)
    }
}
